package com.tapaafandi.tictactoe
...
import com.tapaafandi.tictactoe.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    fun dropIn(view: View) {
        ...
        if (gameState[tappedSlot] == 2 && gameActive) {
            ...
            slotImage.animate().translationYBy(2000f).rotation(1800f).setDuration(1000)

            for (combo in winningPosisitions) {
                if (gameState[combo[0]] == gameState[combo[1]] && gameState[combo[1]] == gameState[combo[2]] && gameState[combo[0]] !=2 ) {
                    ...
                    val playAgainButton = binding.btnPlayAgain
